...
import {httpDelete} from "../../library/RequestLibrary.js";
...
export function createRow(item) {
    library.httpPut("http://127.0.0.1:9080/items/create/", item);
}

export function deleteRow(id) {
    library.httpDelete("http://127.0.0.1:9080/items/delete/" + id);
}